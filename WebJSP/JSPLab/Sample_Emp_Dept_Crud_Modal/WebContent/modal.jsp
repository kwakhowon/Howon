	...
	<form action="EmpEditOk" method="post" id="editform">
		...
		<table class="table"
			...
			<tr>
				...
				<td>사원번호</td>
				<td><input type="text" value="${empedit.empno}" id="empno"
					name="empno" readonly /></td>
			</tr>
			<tr>
				<td>사원이름</td>
				<td><input type="text" value="${empedit.ename}" id="ename"
					name="ename" /></td>
			</tr>
			<tr>
				<td>직책</td>
				<td><input type="text" value="${empedit.job}" id="job"
					name="job" /></td>
			</tr>
			<tr>
				<td>담당자</td>
				<td><input type="text" value="${empedit.mgr}" id="mgr"
					name="mgr" /></td>
			</tr>
			<tr>
				<td>입사일</td>
				<td><input type="text" value="${empedit.hiredate}"
					id="hiredate" name="hiredate" /></td>
			</tr>
			<tr>
				<td>급여</td>
				<td><input type="text" value="${empedit.sal}" id="sal"
					name="sal" /></td>
			</tr>
			<tr>
				<td>수당</td>
				<td><input type="text" value="${empedit.comm}" id="comm"
					name="comm" /></td>
			</tr>
			<tr>
				<td>부서번호</td>
				<td><input type="text" value="${empedit.deptno}" id="deptno"
					name="deptno" /></td>
			</tr>
			<tr>
				<td colspan="2"><br />
